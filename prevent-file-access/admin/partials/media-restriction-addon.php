...
<div id="ip-restrcition" class="tabcontent mo_media_restriction_tabcontent">
	...
	<p style="color: #400d0d;font-size: 12px;" class="mo_media_restriction_notice_background">Check out our available Add-ons below.</p>
...
function get_single_addon_cardt( $tags ) {
	...
	foreach ( $all_addons as $key => $value ) {
		...
		<div class="column_inner" style="border-radius: 5px;">
			<div class="benefits-outer-block">
			<div class="mo_float-container">
			<div class="mo_float-child">
					<img src="<?php echo esc_url( plugins_url( $value['img'], __DIR__ ) ); ?>" style="height:40px;width:40px;" >
				</div>
			<div class="mo_float-child2">
			<div class="mo_oauth_addon_headline"><p style="font-size: 15px;margin: 1px;padding-left: 16px;line-height: 120%;font-weight: 600;font-family: Verdana, Arial, Helvetica, sans-serif;" ><?php echo esc_html( $value['title'] ); ?></p></div>
			</div>
			</div>
			<p style="text-align: center;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12.5px;padding:0px 8px 0px 8px;"><?php echo esc_html( $value['desc'] ); ?></p>
